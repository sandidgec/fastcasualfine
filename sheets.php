...
<head>
    ...
    <br><br><br>
        ...
        <div class="row">
            <div class="col-md-4 text-center">
                <img src="lib/images/corndogsplusmall.jpg" width="210px" height="210px">
                <h2>Corn Dogs Plus </h2>
    ...
    <br><br><br>
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <img src="lib/images/dominos5.png" width="210px" height="210px">
                <h2>Domino's Pizza</h2>
    ...
    <br><br><br>
        ...
        <div class="row">
            <div class="col-md-4 text-center">
                <img src="lib/images/tacobox.jpg" width="210px" height="210px">
                <h2>Taco Box</h2>
